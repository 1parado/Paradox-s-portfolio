...
import { chatAgnesApp, defaultDock, defaultPages, defaultWallpaper, grokSwitchApp, learnPiApp, longcatAgentApp, musicApp, skillsApp } from '@/lib/defaultData';
...
function migrateSkillsAppInPages(value: HomePage[]): HomePage[] {
  ...
  const withPortfolioApps = [chatAgnesApp, longcatAgentApp, grokSwitchApp, learnPiApp].reduce(ensurePortfolioAppInPages, migrated);
