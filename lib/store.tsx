...
import { chatAgnesApp, defaultDock, defaultPages, defaultWallpaper, grokSwitchApp, learnPiApp, longcatAgentApp, musicApp, resolveApp, skillsApp } from '@/lib/defaultData';
...
function migrateSkillsAppInPages(value: HomePage[]): HomePage[] {
  ...
  const withPortfolioApps = [chatAgnesApp, longcatAgentApp, resolveApp, grokSwitchApp, learnPiApp].reduce(ensurePortfolioAppInPages, migrated);
