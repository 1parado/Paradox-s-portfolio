...
export const defaultPages: HomePage[] = [
  {
    ...
    items: [
      ...
      external({ id: 'bookmark-nav', title: '书签导航', icon: '🧭', iconKey: 'bookmark', color: 'from-emerald-400 to-teal-600', description: '常用链接与收藏导航，点击后需要独立密码。', url: 'https://1parado.github.io/bookmarks2website/', password: 'bookmark-2026' }),
      external({ id: 'mentor-review', title: '导师评分', icon: '🧑‍🏫', iconKey: 'mentor', color: 'from-fuchsia-500 to-violet-600', description: '导师评审面板与反馈，点击后需要独立密码。', url: 'https://sprightly-phoenix-8a1e83.netlify.app/', password: 'mentor-2026' }),
      ...
      external({ id: 'agent-lab', title: 'Agent Lab', icon: '🤖', iconKey: 'agent', color: 'from-violet-400 to-purple-600', description: 'AI Agent 与自动化工作流实验占位。', url: 'https://github.com/1parado', externalOnly: true }),
      folder({
        id: 'starter-folder',
        title: '灵感',
        icon: '🗂️',
  ...
  },
  {
    ...
    items: [
      ...
      external({ id: 'email', title: '邮箱', icon: '📮', iconKey: 'mail', color: 'from-amber-400 to-orange-600', description: '邮件联系与合作。', url: 'mailto:2825171479@qq.com', externalOnly: true }),
