      ...
      folder({
        ...
        children: [
          ...
          external({
            ...
            description: '基于 Storybook 的 UI 组件集，在线浏览与交互调试。',
            url: 'https://1parado.github.io/UI_UI/',
            techStack: ['Storybook', 'React', '组件库', 'GitHub Pages'],
          }),
          external({
            id: 'mini-vedio',
            title: 'mini-vedio',
            ...
            description: '极简点对点加密音视频通话应用（Go + Wails v3 + WebRTC），在线 PWA 入口。',
            url: 'https://1parado.github.io/mini-vedio/',
            techStack: ['Go', 'Wails v3', 'WebRTC', 'Vue3', 'PWA'],
          }),
          external({
            id: 'multi-agent-article',
            title: 'Multi-Agent 论文导读',
            icon: 'reading',
            iconKey: 'reading',
            color: 'from-amber-400 to-red-500',
            description: '11 篇 multi-agent 代表性论文（arXiv 2025-09 ~ 2026-09）中文编译与原文链接。',
            url: 'https://github.com/1parado/multi-agent-article',
            techStack: ['Multi-Agent', '论文导读', '静态站点', '纯前端'],
          }),
          chatAgnesApp,
          longcatAgentApp,
          resolveApp,
